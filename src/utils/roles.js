...
export const ROLES = {
  admin: {
    ...
    canDataManage: true, canSetPassword: true, canExport: true,
  },
  standard_admin: {
    ...
    canViewNotifications: true, canViewReports: true,
    canDataManage: false, canSetPassword: false, canExport: true,
  },
  data_entry: {
    label: "Data Entry",
    ...
    canViewNotifications: true, canViewReports: true,
    canDataManage: false, canSetPassword: false, canExport: false,
  },
  view: {
    label: "View Only",
